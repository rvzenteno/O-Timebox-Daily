...
1. **Zero UI Imports in Engines**: `SchedulingEngine`, `ResourceEngine`, `ProjectValidator`, `ProjectCalendar`, and `ProjectCommandManager` remain strictly decoupled from Obsidian and browser DOM APIs.
...
- **Output**: Generates real, explicit WBS subtasks in Markdown under a summary task:
  ...
  - [ ] 1.5 Weekly Site Safety Audits 🛫 2026-09-17 📅 2026-11-05 ⏳ 8d
    ...
    ...
  ```
- **Benefit**: Retains fully transparent CPM scheduling without inventing hidden recurrence daemons.
